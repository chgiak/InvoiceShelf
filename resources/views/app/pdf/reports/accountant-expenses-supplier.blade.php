...
<head>
    <title>@lang('pdf_accountant_expenses_supplier_report_label')</title>
    <style type="text/css">
        body {
...
<body>
    <div class="sub-container">
        <table class="report-header">
            ...
            <tr>
                <td colspan="2">
                    <p class="sub-heading-text">@lang('pdf_accountant_expenses_supplier_report_label')</p>
                </td>
            </tr>
        </table>
        ...
        <table class="expense-detail-table">
            <thead>
                <tr>
                    <th style="width: 20%">@lang('pdf_supplier')</th>
            ...
            <tbody>
                @foreach($groupedExpenses as $customerData)
                <tr>
                    <td>{{ $customerData['supplier'] }}</td>
                    <td>{{ $customerData['vat_id'] }}</td>
                    <td>{{ $customerData['expense_count'] }}</td>
